...
* Recursively remove all adjacent duplicates ([ref](https://practice.geeksforgeeks.org/problems/recursively-remove-all-adjacent-duplicates/0)). [Solution](https://github.com/manoj2411/ds-algo/blob/master/String/RecursivelyRemoveAllAdjDuplicates.rb)
